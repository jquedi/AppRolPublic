<template>
  <div
    id="item2"
    class="h-content w-content flex-1 py-1 flex flex-col"
    v-if="objeto.type == filtro || filtro == ''"
    :key="componentKey"
  >
    <drag
    ...
    >
      ...
      >
        ...
        <div
          class="border-2 border-black h-full rounded-lg ml-2"
    ...
    >
      ...
      <div v-for="(objeto2, index2) in objetos" v-bind:key="index2">
        <subItem2
          v-if="estaItem(objeto2, objeto.name) && id2 != objeto2['id']"
